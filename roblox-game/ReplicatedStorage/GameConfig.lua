...
-- {name, baseRate (coins/tick at lv1), baseCost (lv1->2 upgrade), maxLevel, costMult}
-- lv0->1 is always free (auto-given at claim for first dropper, purchasable for others)
-- lv N->N+1 costs: baseCost * costMult^(N-1)
GameConfig.DROPPERS = {
    [1] = {
